...
<html lang="en">
  <head>
    ...
    <title>@yield('title') | Data Vaksin Kecamatan Gaktau </title>
    <meta charset="utf-8">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('image/jum.jpg')}}" alt="User Image">
        <div>
          ...
          <p class="app-sidebar__user-designation">Kecamatan Gaktau</p>
        </div>
      </div>
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item @yield('vaksin')" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label"> Vaksin </span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{route('vaksin.index')}}"><i class="icon fa fa-circle-o"></i> Data Vaksin </a></li>
            <li><a class="treeview-item" href="{{route('vaksin.create')}}" target="" rel="noopener"><i class="icon fa fa-circle-o"></i> Tambah Data </a></li>
